...
export default function Platform() {
  return (
    <>
      ...
      <main className="bg-[#101014] min-h-screen w-full text-white">
        ...
        <section className="max-w-5xl mx-auto pt-24 pb-16 px-4 text-center flex flex-col items-center">
          ...
          <p className="text-lg md:text-2xl text-gray-300 max-w-2xl mb-10">GIVORO’s modular ad-tech platform gives you complete control — from creative design to street-level delivery to live ROI tracking.</p>
        ...
        <section className="max-w-4xl mx-auto py-16 px-4 flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1">
            ...
            <p className="text-gray-300 mb-6">Track every campaign touchpoint across a single event or a 100+ zone rollout — all in real time.</p>
          </div>
        ...
        <section className="max-w-4xl mx-auto py-16 px-4 flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-300 mb-2">From branded impressions to scan heatmaps to geographic reach — monitor everything.</p>
            <p className="text-gray-300">With modular controls to plan, adapt, and optimize on-ground impact at scale.</p>
          </div>
        </section>
        ...
        <section className="max-w-4xl mx-auto py-16 px-4 flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1">
            ...
            <p className="text-gray-300 mb-2">Launch campaigns that think for themselves. QR tech + utility handouts + precision targeting.</p>
        ...
        <section className="max-w-5xl mx-auto py-20 px-4">
          ...
          <div className="grid md:grid-cols-5 gap-8">
            <div className="bg-[#18181c] rounded-xl border border-[#23232a] p-6 flex flex-col items-center text-center">
              ...
              <div className="font-semibold mb-1">Pick a Product</div>
            ...
            <div className="bg-[#18181c] rounded-xl border border-[#23232a] p-6 flex flex-col items-center text-center">
              ...
              <div className="font-semibold mb-1">Design & Upload</div>
            ...
            <div className="bg-[#18181c] rounded-xl border border-[#23232a] p-6 flex flex-col items-center text-center">
              ...
              <div className="font-semibold mb-1">Launch with Liveboards</div>
            ...
            <div className="bg-[#18181c] rounded-xl border border-[#23232a] p-6 flex flex-col items-center text-center">
              ...
              <div className="font-semibold mb-1">Automated Optimization</div>
